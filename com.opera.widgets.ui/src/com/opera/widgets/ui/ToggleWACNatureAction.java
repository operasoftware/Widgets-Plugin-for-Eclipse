 ...
 * 
 */
public class ToggleWACNatureAction implements IObjectActionDelegate {
	...
	try {
		...
		if (WACWidgetNature.NATURE_ID.equals(natures[i])) {
		    // Remove the nature
	    ...
	    newNatures[natures.length] = WACWidgetNature.NATURE_ID;
	    description.setNatureIds(newNatures);
	    project.setDescription(description, null);
